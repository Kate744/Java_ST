...
public class ContactHelper extends HelperBase{
    ...
    public NewContactData infoFromEditForm(NewContactData contact) {
        ...
        wd.navigate().back();
        return new NewContactData().withId(contact.getId()).withFirstname(firstname).withSecondname(lastname).withAddress(address).withEmail(email).withEmail2(email2).withEmail3(email3).withHomePhone(home).withMobilePhone(mobile).withWorkPhone(work);
